function GBCreate(_x,_y,facing = 0,size = 1,keep_time = 60,fire_time = 60,start_facing = 90,ready = true,flat_count = 1,wait_time = 0,ac_gb = ac_gb_default,glowing = true){
